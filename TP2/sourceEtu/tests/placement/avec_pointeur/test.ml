...
let%test "testGrosDebugCorrect_px" = 
  test (pathFichiersRat^"testGrosDebugCorrect.rat") "main" ("px",1) (0,"SB")

let%test "testGrosDebugCorrect_x" = 
  test (pathFichiersRat^"testGrosDebugCorrect.rat") "main" ("x",1) (1,"SB")

let%test "testGrosDebugCorrect_y" = 
  test (pathFichiersRat^"testGrosDebugCorrect.rat") "main" ("y",1) (2,"SB")

let%test "testGrosDebugCorrect_z" = 
  test (pathFichiersRat^"testGrosDebugCorrect.rat") "main" ("z",1) (3,"SB")